...
try:
    ...
    potentials = api.Potentials.as_view(api.Potentials.NAME, potential, size, nodes, edges)
    ...
    app.add_url_rule('/api/v1/potentials/', defaults={'potential_id': None}, view_func=potentials, methods=['GET', ])
    app.add_url_rule('/api/v1/potentials/<potential_id>', view_func=potentials, methods=['GET', 'DELETE', ])
